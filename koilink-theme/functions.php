...
add_action( 'wp_enqueue_scripts', function () {
	wp_enqueue_style( 'koilink-style', get_stylesheet_uri(), array(), '0.5.1' );
	wp_enqueue_script( 'koilink-js', get_template_directory_uri() . '/js/koilink.js', array(), '0.5.1', true );
...
add_action( 'admin_init', function () {
	if ( ! get_page_by_path( 'publish' ) || ! get_page_by_path( 'me' ) || ! get_page_by_path( 'messages' ) || ! get_page_by_path( 'likes' ) || ! get_page_by_path( 'comments' ) || ! get_page_by_path( 'followers' ) ) {
		koilink_ensure_pages();
		flush_rewrite_rules();
	}
